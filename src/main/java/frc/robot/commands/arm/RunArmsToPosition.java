    ...
    public RunArmsToPosition(ScoringPositions targetPos,
        ...
        addCommands(
            new ConditionalCommand(
                ...
                new RunArmProfiled(LowerArmConstants.MAX_VEL, LowerArmConstants.MAX_ACCEL, lowerArm.getEncoderPosition(),
                    ...
                    lowerArm)
                         ...
                         */
                        .andThen(new RunArmProfiled(UpperArmConstants.MAX_VEL, UpperArmConstants.MAX_ACCEL, upperArm.getEncoderPosition(),
                ...
                new RunArmProfiled(UpperArmConstants.MAX_VEL, UpperArmConstants.MAX_ACCEL, upperArm.getEncoderPosition(),
                    ...
                    upperArm)
                         ...
                         */
                        .andThen(new RunArmProfiled(LowerArmConstants.MAX_VEL, LowerArmConstants.MAX_ACCEL, lowerArm.getEncoderPosition(),
